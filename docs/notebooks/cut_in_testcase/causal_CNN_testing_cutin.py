...
filtered_scenarios = [f[:-4] for f in os.listdir("docs/cutin_split/cutin_filtered_data/") if f.endswith('.pkl')]
lane_change_values = [1.78, 3.81, 5.84]
...
for lcduration in lane_change_values:
    out_csv = f'testing_causal_cnn_cutin_{lcduration:.3f}.csv'
