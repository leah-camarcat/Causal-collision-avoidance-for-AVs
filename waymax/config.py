...
WOD_1_2_1_TEST = DatasetConfig(
    path='C:/Users/JSCHIU/Documents/Project/waymax/data/motion_v_1_2_1/uncompressed/scenario/testing/testing_tfexample.tfrecord@150',
    max_num_rg_points=30000,
    data_format=DataFormat.TFRECORD,
)
WOD_1_2_1_TRAIN_EX = DatasetConfig(
    path='../../data/motion_v_1_2_1/uncompressed/tf_example/training/training_tfexample.tfrecord@1000',
    max_num_rg_points=30000,
    data_format=DataFormat.TFRECORD,
)
WOD_1_2_1_TRAIN = DatasetConfig(
    path='../../data/motion_v_1_3_0/uncompressed/scenario/training/training.tfrecord-00000-of-01000',
    max_num_rg_points=30000,
    data_format=DataFormat.TFRECORD,
)
WOD_1_3_0_TEST = DatasetConfig(
    path='../../data/motion_v_1_3_0/uncompressed/tf_example/testing/testing_tfexample.tfrecord@150',
    max_num_rg_points=30000,
    data_format=DataFormat.TFRECORD,
)
WOD_1_3_0_TRAIN_EX = DatasetConfig(
    path='data/motion_v_1_3_0/uncompressed/tf_example/training/training_tfexample.tfrecord-00012-of-01000',
    max_num_rg_points=30000,
    data_format=DataFormat.TFRECORD,
)
WOD_1_3_0_TRAIN = DatasetConfig(
    path='../../data/motion_v_1_3_0/uncompressed/scenario/training/training.tfrecord-00000-of-01000',
    max_num_rg_points=30000,
    data_format=DataFormat.TFRECORD,
)