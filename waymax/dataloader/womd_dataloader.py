...
# def inspect_dataclass(obj):
#     for field in fields(obj):
#         value = getattr(obj, field.name)
#         print(f"{field.name}: type={type(value)}")
#         if hasattr(value, 'shape'):
#             print(f"  shape={value.shape}")
#             # try:
#             #     print(f"  sample={value[:2]}")  # 只显示前两个元素，防止太大
#             # except Exception as e:
#             #     print(f"  cannot preview values: {e}")
#         print()
...
def simulator_state_generator(
  ...
  # gen = dataloader_utils.get_data_generator(
  #     config, parse_and_preprocess, womd_dict_to_sim_state_func
  # )
  # for i, sim_state in enumerate(gen):
  #     print("sim_trajectory")
  #     inspect_dataclass(sim_state.sim_trajectory)
  #     print("log_trajectory")
  #     inspect_dataclass(sim_state.log_trajectory)
  #     print("log_traffic_light")
  #     inspect_dataclass(sim_state.log_traffic_light)
  #     print("object_metadata")
  #     inspect_dataclass(sim_state.object_metadata)
  #     print("timestep")
  #     inspect_dataclass(sim_state.timestep)
  #     if i >= 0:
  #         break
